...
- **Profile**: editable name, **tappable avatar (camera or gallery picker, persisted across reloads)**, XP bar, 7-tier level system (Newcomer → Legend of CityQuest), badges grid, leaderboard, Postcards gallery (long-press to delete), clickable Passport summary row
