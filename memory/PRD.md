...
- **Virtual Passport on Profile**: 2×2 grid of cities with hero image, country code, progress bar, and a tilted red "VISITED · MMM YYYY" ink stamp once all quests in a city are completed.
