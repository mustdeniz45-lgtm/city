...
import { Alert, Dimensions, FlatList, Linking, Modal, Platform, Pressable, ScrollView, StyleSheet, Text, View } from "react-native";
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        <View style={styles.hero}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <Pressable onPress={() => setLightboxOpen(true)}><Image source={item} style={{ width: screenWidth, height: 320 }} contentFit="cover" /></Pressable>
            )}
          />
          {heroImages.length > 1 && (
